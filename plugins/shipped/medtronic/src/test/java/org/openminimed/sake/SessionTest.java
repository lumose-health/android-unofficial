...
public class SessionTest {
    ...
    @Test
    public void handshake1CDerivesKeysFromKeyDb() {
        Session sess = new Session(null, keyDb());
        sess.handshake0S(PUMP_TEST_MSGS[0]);
    ...
    @Test
    public void handshake2SVerifiesAndCapturesServerKeyMaterial() throws Exception {
        Session sess = new Session(null, keyDb());
        sess.handshake0S(PUMP_TEST_MSGS[0]);
        sess.handshake1C(PUMP_TEST_MSGS[1]);
    ...
    @Test
    public void handshake3CCreatesSeqCryptsWithDerivedKey() throws Exception {
        Session sess = new Session(null, keyDb());
        sess.handshake0S(PUMP_TEST_MSGS[0]);
        sess.handshake1C(PUMP_TEST_MSGS[1]);
        sess.handshake2S(PUMP_TEST_MSGS[2]);
    ...
    @Test
    public void handshake4SDecryptsAndReturnsFalseWithoutClientKeyDb() throws Exception {
        Session sess = new Session(null, keyDb());
        sess.handshake0S(PUMP_TEST_MSGS[0]);
        sess.handshake1C(PUMP_TEST_MSGS[1]);
        sess.handshake2S(PUMP_TEST_MSGS[2]);
        ...
        assertFalse("server-only session has no verifier keys for handshake_4_s", ok);
        assertEquals(3L, sess.serverCrypt().getRxSeq());
    }

    @Test
    public void handshake5CVerifiesClientPermit() throws Exception {
        Session sess = new Session(null, keyDb());
        sess.handshake0S(PUMP_TEST_MSGS[0]);
        sess.handshake1C(PUMP_TEST_MSGS[1]);
        sess.handshake2S(PUMP_TEST_MSGS[2]);
        ...
        assertTrue("client permit must verify against server static keys", ok);
        assertEquals(2L, sess.clientCrypt().getRxSeq());
    }

    @Test
    public void fullHandshakeMatchesCapturedFinalState() throws Exception {
        Session sess = new Session(null, keyDb());
        sess.handshake0S(PUMP_TEST_MSGS[0]);
        sess.handshake1C(PUMP_TEST_MSGS[1]);
        sess.handshake2S(PUMP_TEST_MSGS[2]);
    ...
    @Test
    public void handshake2SThrowsOnTamperedMac() throws Exception {
        Session sess = new Session(null, keyDb());
        sess.handshake0S(PUMP_TEST_MSGS[0]);
        sess.handshake1C(PUMP_TEST_MSGS[1]);
